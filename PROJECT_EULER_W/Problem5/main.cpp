...
© Project Euler Further distribution without consent of the author(s) is prohibited. Author: euler
...
= 4 as no other numbers, 2 ≤ j ≤ 20, can contain more than four repeated factors of 2.
